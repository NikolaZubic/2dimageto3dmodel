...
def init_inception():
    ...
    print('Initializing Inception network...')
    scipy_version = version.parse(scipy.__version__)
    if scipy_version > version.parse('1.3.3') and scipy_version < version.parse('1.5.0'):
        print('[Performance warning] If this step takes too long, downgrade SciPy to version 1.3.3 or update it to 1.5+, e.g. '
